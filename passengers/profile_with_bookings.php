          ...
          if (data.success) {
            ...
            let detailsHTML = `
              ...
              <div class="detail-item">
                ...
                <span class="detail-value">${booking.passenger_name || booking.fullname}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Route:</span>
                <span class="detail-value">${booking.route || 'Not specified'}</span>
              </div>
              <div class="detail-item">
              ...
              <div class="detail-item">
                ...
                <span class="detail-value">${booking.departure_time || 'Not specified'}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Boarding Point:</span>
                <span class="detail-value">${booking.boarding_point || 'Not specified'}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Seats:</span>
                <span class="detail-value">${booking.seats || 1}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Amount:</span>
                <span class="detail-value">${booking.amount || 'Not specified'}</span>
              </div>
              <div class="detail-item">
              ...
              <div class="detail-item">
                ...
                <span class="detail-value">${booking.formatted_created_at || booking.created_at}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Status:</span>
                <span class="detail-value"><span class="booking-status ${booking.status_class}">${booking.status}</span></span>
              </div>
            `;
            ...
            if (booking.assigned_vehicle) {
              detailsHTML += `
                <div class="detail-item">
                  ...
                  <span class="detail-value">${booking.assigned_vehicle}</span>
                </div>
              `;
            }
            ...
            if (booking.driver_name) {
              detailsHTML += `
                ...
                <div class="detail-item">
                  ...
                  <span class="detail-value">${booking.driver_phone || 'Not provided'}</span>
                </div>
              `;
            }
